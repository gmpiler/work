...
14:                                               ; preds = %14, %6
  %15 = phi float [ %18, %14 ], [ %12, %6 ]
  %16 = phi i64 [ %19, %14 ], [ 0, %6 ]
  %17 = phi float [ %25, %14 ], [ %10, %6 ]
  %18 = fadd float %17, %15
  %19 = add nuw i64 %16, 1
  %20 = getelementptr inbounds float, ptr %1, i64 %19
  store float %18, ptr %20, align 4, !tbaa !4
  %21 = getelementptr inbounds float, ptr %3, i64 %19
  %22 = load float, ptr %21, align 4, !tbaa !4
  %23 = getelementptr inbounds float, ptr %2, i64 %19
...
27:                                               ; preds = %14
  %28 = getelementptr inbounds float, ptr %1, i64 %11
  %29 = load float, ptr %28, align 4, !tbaa !4
  %30 = fadd float %25, %29
  %31 = add nuw i64 %16, 2
  %32 = getelementptr inbounds float, ptr %1, i64 %31
  store float %30, ptr %32, align 4, !tbaa !4
  br label %13
}
